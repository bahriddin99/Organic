...
export const OfferDetall = () => {
  const { id } = useParams();
  const data = offers.find((item) => item.id == id);

  return (
    <>
      <div className="flex gap-14">
        <div className=" h-[423px] w-[300px]  bg-[#F9F8F8]  pl-4 rounded-2xl gap-5 shadow-xl mt-9 ml-10 mb-28">
          <div className="">
            <Button
          ...
          <img
            ...
            alt=""
          />
          <h1 className="font-bold text-texts text-xl ">{data.title}</h1>
